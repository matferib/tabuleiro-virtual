...
all:
	scons -j 1 testes=1 tabvirt teste_ent_util teste_ent_acoes
...
apple_test:
	scons sistema=apple debug=1 testes=1 teste_ent_acoes teste_ent_ent teste_modelos teste_ent_util teste_arquivo teste_net_util
