...
"}"));
        ...
        checkbox_nocauteada->setObjectName(QStringLiteral("checkbox_nocauteada"));

        horizontalLayout_17->addWidget(checkbox_nocauteada);

        checkbox_incapacitada = new QCheckBox(tab_geral);
        checkbox_incapacitada->setObjectName(QStringLiteral("checkbox_incapacitada"));

        horizontalLayout_17->addWidget(checkbox_incapacitada);

        checkbox_inconsciente = new QCheckBox(tab_geral);
        checkbox_inconsciente->setObjectName(QStringLiteral("checkbox_inconsciente"));
        ...
        botao_adicionar_ataque->setObjectName(QStringLiteral("botao_adicionar_ataque"));
    ...
    void retranslateUi(QDialog *ifg__qt__DialogoEntidade)
    {
        ...
        checkbox_nocauteada->setText(QApplication::translate("ifg::qt::DialogoEntidade", "Nocauteada", nullptr));
        checkbox_incapacitada->setText(QApplication::translate("ifg::qt::DialogoEntidade", "Incapacitada", nullptr));
        checkbox_inconsciente->setText(QApplication::translate("ifg::qt::DialogoEntidade", "Inconsciente", nullptr));
