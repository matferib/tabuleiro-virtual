...
public:
    ...
    void setupUi(QDialog *ifg__qt__DialogoIluminacao)
    {
        ...
        checkbox_cor_nevoa->setObjectName(QStringLiteral("checkbox_cor_nevoa"));

        horizontalLayout_3->addWidget(checkbox_cor_nevoa);

        botao_cor_nevoa = new QPushButton(groupBox_5);
        botao_cor_nevoa->setObjectName(QStringLiteral("botao_cor_nevoa"));
        ...
        spin_escala_piso_x->setObjectName(QStringLiteral("spin_escala_piso_x"));
        spin_escala_piso_x->setMaximum(1000);
        ...
        spin_escala_piso_y->setObjectName(QStringLiteral("spin_escala_piso_y"));
        spin_escala_piso_y->setMaximum(1000);
    ...
    void retranslateUi(QDialog *ifg__qt__DialogoIluminacao)
    {
...
#endif // QT_NO_TOOLTIP
        checkbox_cor_nevoa->setText(QApplication::translate("ifg::qt::DialogoIluminacao", "Cor", nullptr));
        botao_cor_nevoa->setText(QApplication::translate("ifg::qt::DialogoIluminacao", "Cor da N\303\251voa", nullptr));
        ...
        label_11->setText(QApplication::translate("ifg::qt::DialogoIluminacao", "Escala X", nullptr));
        label_23->setText(QApplication::translate("ifg::qt::DialogoIluminacao", "Escala Y", nullptr));
#ifndef QT_NO_TOOLTIP
