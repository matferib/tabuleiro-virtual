...
**
** Created: Wed Feb 26 16:47:54 2014
...
public:
    ...
    void setupUi(QDialog *ifg__qt__DialogoForma)
    {
        ...
        checkbox_selecionavel->setGeometry(QRect(200, 300, 177, 20));
        ...
        checkbox_visibilidade->setGeometry(QRect(200, 330, 201, 20));
