...
public:
    ...
    QCheckBox *checkbox_luzes_especulares;
    ...
    void setupUi(QDialog *ifg__qt__DialogoOpcoes)
    {
        ...
        verticalLayout_2->addWidget(checkbox_iluminacao_por_pixel);

        checkbox_luzes_especulares = new QCheckBox(groupBox);
        checkbox_luzes_especulares->setObjectName(QStringLiteral("checkbox_luzes_especulares"));

        verticalLayout_2->addWidget(checkbox_luzes_especulares);
    ...
    void retranslateUi(QDialog *ifg__qt__DialogoOpcoes)
    {
        ...
        checkbox_luzes_especulares->setText(QApplication::translate("ifg::qt::DialogoOpcoes", "luzes especulares", nullptr));
    } // retranslateUi
