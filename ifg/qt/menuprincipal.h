...
class MenuPrincipal : public QMenuBar, ntf::Receptor {
 ...
 private:
  ...
  enum menuitem_e { // items de cada menu
    MI_INICIAR = 0, MI_CONECTAR_PROXY, MI_CONECTAR, MI_SAIR,  // ME_JOGO
    MI_DESFAZER = 0, MI_REFAZER, MI_OPCOES, MI_PROPRIEDADES, MI_REINICIAR, MI_SALVAR, MI_SALVAR_COMO,
        MI_RESTAURAR, MI_RESTAURAR_MANTENDO_ENTIDADES, MI_RESTAURAR_VERSAO, MI_REMOVER_CENARIO, MI_SALVAR_CAMERA, MI_REINICIAR_CAMERA,  // ME_TABULEIRO
    MI_PROPRIEDADES_ENTIDADE = 0, MI_ADICIONAR, MI_REMOVER, MI_SALVAR_ENTIDADES,
        MI_RESTAURAR_ENTIDADES, MI_RESTAURAR_ENTIDADES_COMO_NAO_SELECIONAVEIS, 
        MI_SALVAR_MODELO_3D, MI_RESTAURAR_MODELO_3D, // ME_ENTIDADES
    // ME_ACOES eh vazio.
    MI_CILINDRO = 0, MI_CIRCULO, MI_CONE, MI_CUBO, MI_ESFERA, MI_LIVRE, MI_PIRAMIDE, MI_RETANGULO, MI_TRIANGULO,
