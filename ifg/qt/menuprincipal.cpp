...
const char* g_menuitem_strs[] = {
  ...
  QT_TRANSLATE_NOOP("ifg::qt::MenuPrincipal", "Desfazer (Ctrl + Z)"), QT_TRANSLATE_NOOP("ifg::qt::MenuPrincipal", "Refazer (Ctrl + Y)"), nullptr,
    ...
    QT_TRANSLATE_NOOP("ifg::qt::MenuPrincipal", "Res&taurar mantendo Entidades"), 
    QT_TRANSLATE_NOOP("ifg::qt::MenuPrincipal", "Restaurar Versão"),nullptr,
...
void MenuPrincipal::Modo(modomenu_e modo){
  ...
  case MM_JOGADOR:
    ...
    EstadoItemMenu(false, ME_TABULEIRO, { MI_PROPRIEDADES, MI_REINICIAR, MI_SALVAR, MI_SALVAR_COMO, MI_RESTAURAR, MI_RESTAURAR_MANTENDO_ENTIDADES, MI_RESTAURAR_VERSAO });
