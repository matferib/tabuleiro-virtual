...
Principal* Principal::Cria(
    int& argc, char** argv, bool anti_aliasing,
  ...
  return new Principal(argc, argv, anti_aliasing, tabuleiro, texturas, teclado_mouse, central, q_app);
}

Principal::Principal(int& argc, char** argv, bool anti_aliasing,
    ...
    : QWidget(NULL), central_(central), q_app_(q_app), q_timer_(new QTimer(this)),
      ...
      v3d_(new Visualizador3d(&argc, argv, anti_aliasing, teclado_mouse, central, tabuleiro, this)) {
