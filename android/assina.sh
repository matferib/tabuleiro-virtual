...
/Users/mribeiro/android/adt/sdk/build-tools/22.0.1/zipalign -v 4 bin/TabuleiroVirtual-release-unsigned.apk bin/TabuleiroVirtual-release-${VERSAO}.apk || \
echo "Erro assinando"
