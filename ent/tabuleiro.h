...
class Tabuleiro : public ntf::Receptor {
  ...
  */
  ...
  void BebeOuAplicaItemMundanoNotificando(unsigned int id_entidade, int indice_item);
  void BebeOuAplicaItemMaravilhosoNotificando(unsigned int id_entidade, int indice_item);
  ...
  */
  ...
  void TrataRolarContraIntimidacaoNotificando(float atraso_s, bool desmoralizar, const std::pair<int, int>& total_modificadores, const Entidade& entidade_origem, const Entidade& entidde_destino);
  ...
  * para botoes com estado. */
  ...
  bool MapeamentoNeve() const { return opcoes_.mapeamento_neve() && variaveis_clima_.transicao > 0.0f; }
  ...
  void AtualizaRegeneracaoAoPassarRodada(const Entidade& entidade, ntf::Notificacao* grupo, ntf::Notificacao* grupo_desfazer);
